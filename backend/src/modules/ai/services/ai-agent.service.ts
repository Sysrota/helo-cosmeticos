...
- Condições vigentes: ${commercialPolicy.moto_uber_enabled ? "Retirar em mãos grátis pode aparecer para Goiânia e região metropolitana em qualquer valor de compra. Moto Uber pode aparecer para Goiânia e região metropolitana; em compras acima de " + freeShippingMinimum + " tem valor fixo de R$ 10,00 no checkout, e em compras abaixo desse valor o cliente paga o valor da Moto Uber ao entregador" : "Retirar em mãos e Moto Uber não estão disponíveis no momento"}
...
- Quando houver "Retirar em mãos" em options, apresente como opção grátis de retirada. Se também houver "Moto Uber", apresente como entrega local rápida; se options.price for 10, informe valor fixo de R$ 10,00 no checkout; se options.price for 0 e o prazo indicar "Valor pago ao entregador", informe que o valor da Moto Uber será pago ao entregador. Depois apresente as demais opções em ordem do menor para o maior valor final
...
- Se calculate_shipping retornar policy "free_shipping_threshold", diga que a compra atingiu o frete grátis acima de ${freeShippingMinimum}; informe cada serviço, prazo e valor final retornado em options.price. Retirar em mãos é grátis e Moto Uber, quando aparecer nessa condição, tem valor fixo de R$ 10,00
...
- Se uma opção "Moto Uber" estiver em options, explique que é entrega local rápida para Goiânia e região metropolitana; quando o valor retornado for R$ 10,00, esse valor é cobrado no checkout; quando o valor retornado for R$ 0,00 com prazo "Valor pago ao entregador", explique que o valor da Moto Uber será pago ao entregador
